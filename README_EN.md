...
| | Cloud UI | [RClient ICS](./projects/rclient-ics/) | STB cloud image streaming client | `C` `AES` `libpng` |
...
| [LnHud](./projects/lnhud/) | macOS input source switch HUD overlay | `Swift` `SwiftUI` `AppKit` | 2026 | <a href="https://apps.apple.com/kr/app/lnhud/id6762333462?mt=12"><img src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg" height="20"></a> |
