...
### 달력 팝업
*클릭하면 미니 달력이 나타납니다. 일요일과 공휴일은 붉은색으로 표시됩니다.*

![달력 팝업](./images/screenshot-popup_2880x1800.png)

### 공휴일 툴팁
*공휴일에 마우스를 올리면 공휴일명이 표시됩니다.*

![공휴일 툴팁](./images/screenshot-tooltip_2880x1800.png)

### 설정 화면
*다양한 옵션을 설정할 수 있습니다.*

![설정 화면](./images/screenshot-preference_2880x1800.png)
...
graph TD
    subgraph MB["메뉴바 아이템"]
        A["날짜/시간 표시 (커스터마이즈 가능)\n예: 12월 23일 (월) 11:24"]
    end

    A -->|클릭| B

    subgraph POP["캘린더 팝오버 (SwiftUI)"]
        B[월간 달력 뷰\n공휴일 표시]
    end

    subgraph PREF["환경설정 창"]
        C[시간 형식 12h/24h]
        D[날짜 형식 패턴]
        E[주 시작 요일]
        F[공휴일 국가 선택]
