...
| 필드 | 크기 | 설명 |
|------|------|------|
| Command | 1 byte | 명령어 타입 |
| Image Format | 1 byte | 이미지 포맷 |
| Left/Top/Right/Bottom | 2 bytes each | 셀 위치 |
| Width/Height | 2 bytes each | 이미지 크기 |
| Animation | 1 byte | 애니메이션 플래그 |
| Image Count | 1 byte | 이미지 개수 |
| Field Length | 2 bytes | 필드 길이 |
| Image Size | 4 bytes | 이미지 데이터 크기 |
| Image Data | variable | 이미지 바이너리 |
