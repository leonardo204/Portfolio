...
이 포트폴리오는 제가 참여한 다양한 프로젝트들을 정리한 공간입니다.
...
| 프로젝트 | 설명 | 주요 기술 |
|---------|------|----------|
| [VTT Media AI Agent Chat](./projects/vtt-assistant-chat/) | AI 에이전트 플랫폼 연동 테스트용 채팅 애플리케이션 | Electron, Node.js, Express |
...
| [SimpleSecretRotto](./projects/simple-secret-rotto/) | AI 기반 로또 번호 분석 및 추천 앱 | Swift, SwiftUI, REST API |
| [zeroPlayer](./projects/zero-player/) | YouTube 플레이리스트 기반 음악 스트리밍 앱 | Swift, UIKit, YoutubeKit |
| [blackRadio](./projects/black-radio/) | watchOS 한국 라디오 스트리밍 앱 | Swift, SwiftUI, AVFoundation |
